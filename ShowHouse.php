...
$PageIndexTwo = "Maisons";
$PageIndexTwoLink = "maisons.php";
		                        ...
		                        <aside class="profile-nav alt">
		                            <section class="card">
		                                <div class="card-header user-header alt bg-dark">
		                                    <div class="media">
		                                        <div class="media-body">
		                                            <h2 class="text-light display-6 text-center"><?= $Type."<br>de</br>".GetUserExtrem($donnees['pid']) ?></h2>
		                                        </div>
		                                    </div>
		                                </div>
		                                ...
		                                <ul class="list-group list-group-flush">
		                                    ...
		                                    <li class="list-group-item">
		                                        <i class="fa fa-car"></i> <strong class="card-title"> Type : <?= $Type ?></strong>
		                                    </li>
		                                    <li class="list-group-item">
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
                    ...
                    <a href="functions/delHouse.php?id=<?= $donnees['id']?>&pid=<?= $donnees['pid']?>"><button type="submit" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"> </i> Confirmer</button></a>
				</div>
			</div>
		</div>
	</div>
