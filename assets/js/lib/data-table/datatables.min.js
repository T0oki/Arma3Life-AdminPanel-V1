...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"No data available in table",sInfo:"Montrer de _START_ à _END_ sur _TOTAL_ Entrées",sInfoEmpty:"Montrer de 0 à 0 sur 0 Entrées",
sInfoFiltered:"(filtered from _MAX_ total Entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Voir _MENU_ Entrées",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
