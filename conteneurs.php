...
// Check Permissions
$Acces = false;
if ($PERM_View_Container) $Acces = true;
?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Conteneurs</strong>
                                </div>
                                <div class="card-body">
                                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $reponse = $serveur_bdd->query("SELECT * FROM containers");
                                            while ($donnees = $reponse->fetch())
                                            {
                                                ...
                                                <td><?php echo $donnees['pos'];?></td>
                                                <td><a class="btn btn-primary" href="ShowContener.php?id=<?php echo $donnees['id'];?>" role="button">Edit</a></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
